      ...
      >
        <div class="space-y-2 mb-6">
          <p class="text-sm text-gray-600">
            Children:{" "}
            <strong data-testid="restore-child-count" class="text-gray-800">
              {safeChildCount}
            </strong>
          </p>
          <p class="text-sm text-gray-600">
            Transactions:{" "}
            <strong
              data-testid="restore-transaction-count"
              class="text-gray-800"
            >
          ...
          <p class="text-sm text-gray-600">
            Exported at:{" "}
            <strong data-testid="restore-exported-at" class="text-gray-800">
              {safeExportedAt}
            </strong>
          </p>
        </div>
...
export function RestoreError({ message }: { message: string }) {
  ...
  return (
    ...
    >
      ...
      <a href="/" class="text-sm text-red-600 hover:text-red-800 underline">
        Back to Home
      </a>
    </div>
  );
