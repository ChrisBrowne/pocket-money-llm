...
The app runs on a Proxmox LXC (ADR-0009). It needs a process manager to keep it running and a deployment mechanism to update it. Options range from Docker/container images to simple git-based deployment.
