...
Transactions could allow backdating (e.g. "I gave them money yesterday but forgot to log it") or always use the server time when the transaction is recorded.
